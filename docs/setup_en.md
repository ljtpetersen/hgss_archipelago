...
3. Follow the general Archipelago instructions
   ...
   This will generate an output file for you. Depending on the version you chose,
   your patch file will have the `.apheartgold` or the `.apsoulsilver` file extension.
   It will be inside the output file.
